    ...
    <div className="flex justify-center items-center h-[calc(100vh-80px)] px-4">
      <div className="bg-zinc-800 border border-zinc-700 p-8 rounded-2xl w-full max-w-md shadow-2xl">
        ...
        <form onSubmit={onSubmit} className="flex flex-col gap-y-4">
          <div>
            <label className="text-zinc-300 text-sm font-medium mb-1 block">Nombre de usuario</label>
            <input
              type="text"
            ...
            />
            {errors.username && <p className="text-red-400 text-xs mt-1">El nombre de usuario es requerido</p>}
          </div>
